...
const getCategoryColor = (category: string) => {
  const colorMap: Record<string, string> = {
    "Student Statistics":
      "bg-poly-blue-100 text-poly-blue-600 border-poly-blue-200",
    "Academic Performance":
      "bg-poly-green-100 text-poly-green-600 border-poly-green-200",
    ...
    <section id="institutional-data" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Comprehensive data overview showcasing our institutional excellence
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {institutionalData?.map((dataItem) => {
            ...
            return (
              <Card
                key={dataItem.id}
                className={`border-2 hover:shadow-lg transition-shadow ${colorClasses}`}
              >
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div
                      className={`w-12 h-12 rounded-full flex items-center justify-center ${colorClasses}`}
                    >
        ...
        <div className="mt-16 bg-white rounded-xl p-8 shadow-lg">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-4xl mx-auto">
              These performance indicators reflect Federal Polytechnic Ede's
              commitment to the educational excellence framework established by
              the Honorable Minister of Education, Mr. Tunji Alausa. Our
              institution continues to set benchmarks in technical education,
              research innovation, and graduate employability across Nigeria and
          ...
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div className="p-4">
              <div className="text-2xl font-bold text-poly-blue-600 mb-2">
                2024
              </div>
              <p className="text-sm text-gray-600">Assessment Year</p>
            </div>
            <div className="p-4">
              <div className="text-2xl font-bold text-poly-green-600 mb-2">
                Top 5
              </div>
              <p className="text-sm text-gray-600">Nigerian Polytechnics</p>
            </div>
            <div className="p-4">
              <div className="text-2xl font-bold text-poly-red-600 mb-2">
                NSQ{" "}
              </div>
